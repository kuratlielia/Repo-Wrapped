/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4abf96d3d740b3935790d3223fda4c8d)
// Runtime types generated with workerd@1.20260730.1 2026-04-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	Agent: DurableObjectNamespace<import("./src/worker/index").Agent>;
	LEADERBOARD: DurableObjectNamespace<import("./src/worker/index").LeaderboardDO>;
	WORKER_SELF_REFERENCE: Service<typeof import("./src/worker/index").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "Agent" | "LeaderboardDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WRAP_MODEL" | "CF_AI_GATEWAY">> {}
}
